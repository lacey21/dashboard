...
const GRANTS: Grant[] = [
  {
    name: "On-Farm Climate Action Fund (OFCAF)",
    funder: "Agriculture and Agri-Food Canada",
    blurb: "Cost-share for nitrogen management, cover cropping, and rotational practices that reduce emissions. $300M expansion announced Jan 2025.",
  ...
  {
    name: "ACT Program — Adoption Stream",
    funder: "Agriculture and Agri-Food Canada",
    blurb: "Funding for energy-efficient and clean-tech equipment — precision lighting, heating systems, and greenhouse automation. $116M announced Feb 2025.",
    url: "https://agriculture.canada.ca/en/programs/agricultural-clean-technology-adoption-stream",
    categories: ["energyIntensity", "carbonEmissions"],
  },
  {
    name: "BC Beneficial Management Practices (BMP)",
    funder: "Investment Agriculture Foundation of BC",
    blurb: "Up to $100,000 per farm for water, soil, and pest stewardship projects under Sustainable CAP. Delivered by IAF BC.",
    url: "https://iafbc.ca/beneficial-management-practices-program/",
    categories: ["waterEfficiency", "chemicalLoad", "naturalDisasterRisk"],
  },
  {
    name: "BC Environmental Farm Plan (EFP)",
    funder: "Investment Agriculture Foundation of BC",
    blurb: "Free, confidential on-farm climate risk assessment that unlocks eligibility for BMP and other cost-share programs.",
    url: "https://iafbc.ca/environmental-farm-plan/",
    categories: ["waterEfficiency", "chemicalLoad", "carbonEmissions", "naturalDisasterRisk"],
  },
  {
    name: "BC Agriculture Programs Hub",
    funder: "BC Ministry of Agriculture & Sustainable CAP",
    blurb: "Index of all active BC provincial programs — Agri-Business Planning, Climate Adaptation, and Sustainable CAP cost-share streams.",
  ...
  },
  {
    ...
    blurb: "Up to $4,000 cash-back on FCC lending for farms enrolled in an approved sustainability initiative. Program open until Jan 31, 2026.",
    url: "https://www.fcc-fac.ca/en/financing/agriculture/sustainability-incentive-program",
    categories: ["waterEfficiency", "energyIntensity", "chemicalLoad", "carbonEmissions", "naturalDisasterRisk"],
  },
];
